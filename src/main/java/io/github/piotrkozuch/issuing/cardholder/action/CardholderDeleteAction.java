...
@Component
public class CardholderDeleteAction implements Action<CardholderDeleteAction.Params, Cardholder> {
    ...
    @Autowired
    public CardholderDeleteAction(CardholderRepository cardholderRepository) {
    ...
    public Optional<Cardholder> execute(Params params) {
        final var cardholder = cardholderRepository.get(params.cardholderId).delete();
